...
export default function PhoneVerification({ onNext, onBack, phoneNumber }: PhoneVerificationProps) {
  console.log("PhoneVerification: Component rendered with phoneNumber:", phoneNumber);
  const [code, setCode] = useState(["", "", "", "", "", ""]);
  const inputRefs = useRef<(TextInput | null)[]>([]);

  const handleNext = () => {
    const fullCode = code.join("");
    console.log("PhoneVerification: handleNext called with code:", fullCode);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.buttonSection}>
          <TouchableOpacity style={styles.verifyButton} onPress={handleNext}>
            <Text style={styles.verifyButtonText}>Verify Your Phone</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
